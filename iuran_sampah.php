     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            <li><a href="index.php">Home</a></li>            
            <li class="active">Iuran Sampah</li>
          </ol>
         </div>
       </div>
     </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-right">                            
                 <img class="media-object" src="assets/img/sampah.png" alt="img" width="100%">
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-left">
                  <!-- Start Title -->
                  <div class="mu-title">
                    <h2>Informasi Iuran Sampah</h2>              
                  </div>
                  <!-- End Title -->
                  <?php foreach ($hasilInputan as $hasil) : ?>
                    <p style="text-align: justify;"><?= $hasil["keterangan"] ; ?> </p>
                  <?php endforeach; ?>
                </div>
              </div>
            </div>
