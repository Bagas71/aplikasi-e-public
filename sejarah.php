...
<html lang="en">
  <head>
    ...
    <title>Sejarah Perumahan Lili</title>
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>Sejarah Perumahan</h2>
           <ol class="breadcrumb">
            <li><a href="index.php">Home</a></li>            
            <li class="active">Sejarah Perumahan</li>
          </ol>
         </div>
       </div>
     </div>
                    ...
                    <div class="col-md-12">
                      <article class="mu-blog-single-item">
                        <figure class="mu-blog-single-img">
                          <a href="#"><img alt="img" src="assets/img/1.jpeg"></a>
                          <figcaption class="mu-blog-caption">
                            <h3><a href="#">SEJARAH PERUMAHAN LILI</a></h3>
                          </figcaption>                      
                        </figure>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="mu-footer-widget">
                ...
                <form class="mu-subscribe-form">
                  <input type="email" placeholder="Berikan Kritik & Saran">
                  <button class="mu-subscribe-btn" type="submit">Kirim!</button>
                </form>               
              </div>
            </div>
