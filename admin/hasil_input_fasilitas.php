...
<head>
    ...
    <title>Hasil Input Fasilitas Perumahan</title>
        ...
        <div class="row">
           ...
           <section class="panel panel-primary">
                    <header class="panel-heading">
                        Hasil Inputan Fasilitas Perumahan
                        ...
                        <section id="no-more-tables">
                            <table action="" method="post" class="table table-bordered table-striped table-condensed cf">
                                ...
                                <tr>
                                    ...
                                    <td data-title="Foto"><img width="70" height="70" src="images/img/<?= $hasil["foto"] ?>"></td>
                                    <td data-title="Judul Foto"><?= $hasil["judul"] ; ?></td>
                                    <td data-title="Aksi">
                                        <a href="ubah_fasilitas.php?id=<?=$hasil["id"];?>" class="btn btn-success">Ubah</a> |
                                        <a href="hapus_fasilitas.php?id=<?=$hasil["id"];?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>    
