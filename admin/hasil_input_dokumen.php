...
$hasilInputan = query("SELECT*FROM dokumen");
...
<head>
    ...
    <title>Hasil Input Dokumen</title>
                        ...
                        <section id="no-more-tables">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td data-title="Dokumen"><a href="dokumen/<?= $hasil["nama"] ; ?>"><?= $hasil["nama"] ; ?></a></td>
                                <td data-title="Aksi">
                                    <a href="ubah_dokumen.php?id=<?=$hasil["id"];?>" class="btn btn-success">Ubah</a>
                                    <a href="hapus_dokumen.php?id=<?=$hasil["id"];?>" class="btn btn-danger">hapus</a>
                                </td>
                            </tr>
                             <?php $i++; ?>
                            <?php endforeach; ?>
