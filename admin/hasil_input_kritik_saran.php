        ...
        <div class="row">
           ...
           <section class="panel panel-primary">
                    <header class="panel-heading">
                        Hasil Inputan Saran dan Kritik
                        ...
                        <section id="no-more-tables">
                            <table action="" method="post" class="table table-bordered table-striped table-condensed cf">
                                ...
                                <tr>
                                    ...
                                    <td data-title="Nama"><?= $hasil["nama"] ; ?></td>
                                    <td data-title="Saran dan Kritik"><?= $hasil["saran_kritik"] ; ?></td>
                                    <td data-title="Tanggal"><?= $hasil["tanggal"] ; ?></td>


                                    <td data-title="Aksi">
                                            <a href="hapus_kritik_saran.php?id=<?=$hasil["id"];?>" class="btn btn-danger">Hapus</a>
                                        </td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>    
