...
<head>
    ...
    <title>Hasil Input Rapat Warga</title>
        ...
        <div class="row">
           ...
           <section class="panel panel-primary">
                    <header class="panel-heading">
                        Hasil Inputan Hasil Rapat Warga
                        ...
                        <section id="no-more-tables">
                            <table action="" method="post" class="table table-bordered table-striped table-condensed cf">
                                ...
                                <tr>
                                    ...
                                    <td data-title="Tanggal"><?= $hasil["tanggal"];  ?></td>
                                    <td data-title="Foto"><img width="70" height="70" src="images/<?= $hasil["foto"] ?>"></td>
                                    <td data-title="Hasil Rapat"><?= $hasil["hasil_rapat"] ; ?></td>
                                    <td data-title="Aksi">
                                        <a href="ubah_hasil_rapat.php?id=<?=$hasil["id"];?>" class="btn btn-success">Ubah</a>
                                        <a href="hapus_hasil_rapat.php?id=<?=$hasil["id"];?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>    
