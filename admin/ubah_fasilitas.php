...
require 'functions.php';
 ...
 // query data berdasarkan id
    $ubahHasil = query("SELECT*FROM tabel_fasilitas WHERE id = $id")[0];
    ...
    if (ubahFasilitas($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'ubah_fasilitas.php?id=$id';
            </script>
            ";
    }
}
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="file" name="gambar"  class="form-control" id="gambar"><br>
                                     <img src="images/img/<?= $ubahHasil["foto"]; ?>" width="90" height="70">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea type="text" name="judul"  class="form-control" id="judul" required><?= $ubahHasil["judul"]; ?></textarea>
                                </div>
                            </div>
                        
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" name="ubahFasilitas"  class="btn btn-success btn-sm">Simpan</button> 
