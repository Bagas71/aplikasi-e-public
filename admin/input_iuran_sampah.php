    ...
    if (tambahSampah($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'input_iuran_sampah.php';
            </script>
            ";
    }
}
...
<head>
    ...
    <title>Inputan Iuran Sampah</title>
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea type="text" name="keterangan"  class="form-control" id="keterangan" placeholder="Masukkan Keterangan Iuran Sampah..." required></textarea>
                                </div>
                            </div>
                        
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" name="tambahSampah"  class="btn btn-success btn-sm">Simpan</button> 
