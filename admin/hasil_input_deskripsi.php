...
<head>
    ...
    <title>Hasil Input Deskripsi</title>
        ...
        <div class="row">
           ...
           <section class="panel panel-primary">
                    <header class="panel-heading">
                        Hasil Inputan Deskripsi Perumahan
                        ...
                        <section id="no-more-tables">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td data-title="Deskripsi"><?= $hasil["deskripsi"] ; ?></td>
                                <td data-title="Aksi">
                                    <a href="ubah_deskripsi.php?id=<?=$hasil["id"];?>" class="btn btn-success">Ubah</a>
                                    <a href="hapus_deskripsi.php?id=<?=$hasil["id"];?>" class="btn btn-danger">hapus</a>
                                </td>
                            </tr>
                             <?php $i++; ?>
                            <?php endforeach; ?>
