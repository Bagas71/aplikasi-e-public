...
$hasilInputan = query("SELECT*FROM tabel_sampah");
...
<head>
    ...
    <title>Hasil Input Iuran Sampah</title>
                        ...
                        <section id="no-more-tables">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td data-title="Aksi">
                                    <a href="ubah_iuran_sampah.php?id=<?=$hasil["id"];?>" class="btn btn-success">Ubah</a>
                                    <a href="hapus_sampah.php?id=<?=$hasil["id"];?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                             <?php $i++; ?>
                            <?php endforeach; ?>
