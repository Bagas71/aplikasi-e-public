     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>Iuran Keamanan</h2>
           <ol class="breadcrumb">
            <li><a href="index.php">Home</a></li>            
            <li class="active">Iuran Keamanan</li>
          </ol>
         </div>
       </div>
     </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-right">                            
                 <img class="media-object" src="assets/img/keamanan.png" alt="img"  width="100%">
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                ...
                <div class="mu-about-us-left">
                  <!-- Start Title -->
                  <div class="mu-title">
                    <h2>Informasi Iuran Keamanan</h2>              
                  </div>
                  <!-- End Title -->
                  <p><?= $hasil["keterangan"] ; ?></p>
                  <ul>
                    <li>Tipe Rumah Besar : Rp. <?= number_format($hasil['tipe_besar']);?></li>
                    <li>Tipe Rumah kecil : Rp. <?= number_format($hasil['tipe_kecil']);?></li>
                    <li>Kantor           : Rp. <?= number_format($hasil['kantor']);?></li>
                  </ul>
                  <p>Untuk masalah iuran kemanan sewaktu-waktu akan berubah tergantung dari kesepatan bersama.!</p>
                </div>
                <?php endforeach; ?>
              </div>
            </div>
