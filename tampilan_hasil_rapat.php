     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <ol class="breadcrumb">
            <li><a href="hasil_rapat.php">Hasil Rapat</a></li>            
            <li class="active">Hasil Pembahasan Rapat Warga</li>
          </ol>
         </div>
       </div>
     </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mu-related-item">
                      ...
                      <h3 style="margin-top: -50px;">Rapat Warga Pada Tanggal : <?= $hasil["tanggal"]; ?> </h3>
                      <p><?= $hasil["hasil_rapat"]; ?> </p>
                      <?php endforeach; ?>  
                    </div>
                  </div>
                </div>
